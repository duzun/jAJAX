...
e=function h(a,d,g){var b=h.createXHR(!1);if(!b)return g&&g(null,"xhr","Couldn't create XHR object"),b;"string"==typeof a&&(a={url:a});a=E({url:"",type:"GET",cache:!1,timeout:null,contentType:"application/x-www-form-urlencoded; charset=UTF-8",dataType:"",mimeType:"",data:null,headers:null,error:null,success:null},a);var e={},k=function(a,c){e[a.toLowerCase()]=[a,c]},c=a.type,t,l=function(C,c,d,l){a.error&&a.error(d||l,c,C,l);g&&g(d||l,c,C,l)},G=function(c,y){var b=c.responseText,t=a.dataType||h.mimeToDataType(a.mimeType||
